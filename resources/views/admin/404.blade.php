...
<div class="hgroup">
    ...
    <h2>Φαίνεται πως η σελίδα που αναζητάτε δεν είναι πλέον διαθέσιμη.</h2>
    <a href="{{ route('dashboard') }}">
        <button type="button" class="btn btn-responsive button-alignment" style="margin-bottom:7px;">Αρχική</button>
    </a>
</div>
<!-- global js -->
