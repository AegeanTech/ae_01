    ...
    <div class="media-container">
        ...
        <section class="site-section site-section-light site-section-top">
            <div class="container text-center">
                <h1 class="animation-slideDown"><strong>Αναζητήστε άμεσα τον επαγγελματία που θέλετε!</strong></h1>
                <h2 class="h3 animation-slideUp hidden-xs">Περισσότερες από 5.000 εγγεγραμένες επιχειρήσεις!</h2>
            </div>
        </section>
        <!-- END Intro -->
