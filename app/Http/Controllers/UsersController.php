...
class UsersController extends JoshController
{
    ...
    public function getIndex()
    {
        ...
        // Show the page
        return View('admin.users.index', $this->getInitialData(), compact('users'));
    }
    ...
    public function getCreate()
    {
        ...
        // Show the page
        return View('admin/users/create', $this->getInitialData(), compact('groups'));
    }
    ...
    public function getEdit($id = null)
    {
        ...
        // Show the page
        return View('admin/users/edit', $this->getInitialData(), compact('user', 'roles', 'userRoles','countries','status'));
    }
    ...
    public function getDeletedUsers()
    {
        ...
        // Show the page
        return View('admin/deleted_users', $this->getInitialData(), compact('users'));
    }
    ...
    public function getModalDelete($id = null)
    {
        ...
        try {
            ...
            if ($user->id === Sentinel::getUser()->id)  {
                ...
                return View('admin/layouts/modal_confirmation', $this->getInitialData(), compact('error', 'model', 'confirm_route'));
            }
        } catch (UserNotFoundException $e) {
            // Prepare the error message
            $error = Lang::get('users/message.user_not_found', compact('id' ));
    ...
    public function show($id)
    {
        ...
        // Show the page
        return View('admin.users.show', $this->getInitialData(), compact('user'));
