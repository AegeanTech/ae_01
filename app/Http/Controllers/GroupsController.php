...
{
    /**
     * Show a list of initial data of user.
     *
     * @return View
     */
    ...
    public function getIndex()
    {
        ...
        // Show the page
        return View('admin/groups/index', $this->getInitialData(), compact('roles'));
    }
    ...
    {
        // Show the page
        return View('admin/groups/create', $this->getInitialData());
    }
    ...
    public function getEdit($id = null)
    {
        ...
        // Show the page
        return View('admin/groups/edit', $this->getInitialData(), compact('role'));
    }
